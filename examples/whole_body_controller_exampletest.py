...
recv_data = b'$J\x08\x00\x08\x00\x08\x00\x08\x00\x08\x00\x08\x00\x01\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x01\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00'
...
def dog_action():
  ...
  a=b'$J\x08\x00\x08\x00\x08\x00\x08\x00\x08\x00\x08\x00\x01\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00'
  ...
  while current_time - start_time < FLAGS.max_time_secs:
    ...
    if a!=recv_data and len(recv_data)>10:
      # while True :
...
def main(argv):
  ...
  del argv # unused
  thread1=threading.Thread(target=recvmsg)
  thread1.start()
  thread2=threading.Thread(target=dog_action)
  thread2.start()
